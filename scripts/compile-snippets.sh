...
tasks_for() {
  case "$1" in
    ...
    kmp)          echo ":kmp:compileKotlinJvm :kmp:compileAndroidMain :kmp:compileCommonMainKotlinMetadata :kmp:compileKotlinJs" ;;
    kmp-test)     echo ":kmp:compileTestKotlinJvm :kmp:compileTestKotlinJs" ;;
